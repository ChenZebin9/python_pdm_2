...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pickupFromJoAction = QtWidgets.QAction(MainWindow)
        self.pickupFromJoAction.setObjectName("pickupFromJoAction")
        self.assignMaterialSiteAction = QtWidgets.QAction(MainWindow)
        self.assignMaterialSiteAction.setObjectName("assignMaterialSiteAction")
        self.assignMaterialJoStoringAction = QtWidgets.QAction(MainWindow)
        self.assignMaterialJoStoringAction.setObjectName("assignMaterialJoStoringAction")
        self.createAssignedListAction = QtWidgets.QAction(MainWindow)
        self.createAssignedListAction.setObjectName("createAssignedListAction")
        ...
        self.menu_7.addAction(self.pickupFromJoAction)
        ...
        self.menu_5.addSeparator()
        self.menu_5.addAction(self.createAssignedListAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pickupFromJoAction.setText(_translate("MainWindow", "钜欧..."))
        self.assignMaterialSiteAction.setText(_translate("MainWindow", "现场"))
        self.assignMaterialJoStoringAction.setText(_translate("MainWindow", "钜欧仓库"))
        self.createAssignedListAction.setText(_translate("MainWindow", "生成预分配清单..."))
