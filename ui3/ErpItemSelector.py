...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.doSearchPushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.doSearchPushButton.setObjectName("doSearchPushButton")
        self.h_layout.addWidget(self.doSearchPushButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.doSearchPushButton.setText(_translate("Dialog", "Search"))
